...
class SecondSkyCountdownCog(commands.Cog):
    ...
    async def days_to_second_sky_auto(self):
        ...
        secondsky_message_embed.set_thumbnail(url="https://aegwebprod.blob.core.windows.net/content/footer_logo_images/261/qvKDXDxrRxW29MiGzmUhspO5T1eRcJU5qhgeiG0V.jpg")
